  ...
  return (
    <main className="app-shell">
      ...
      <section className="workspace-card">
        ...
        {view === "story" && <CourseDesignStory course={course} onNavigate={(next) => setView(next)} />}
